...
async def get_album_popularity(
    ...
    return await calculate_album_popularity(album_id, from_date, to_date)
...
async def get_artist_popularity(
    ...
    return await calculate_artist_popularity(artist_id, from_date, to_date)
...
async def get_track_popularity(
    ...
    return await calculate_track_popularity(track_id, from_date, to_date)
